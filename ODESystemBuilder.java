 ...
 *
 * Implements ODEFunction so it can be passed directly to EulerSolver or RungeKutta4
...
public class ODESystemBuilder implements ODEFunction {
     ...
     *
     * @param stateRightNow  current values of all variables, in the same order as names[]
