...
public interface ODEFunction {
    // you give it the current state of the system (positions, velocities etc packed into an array)
    ...
    // stateRightNow is just whatever the ball/system looks like at this exact moment in time
